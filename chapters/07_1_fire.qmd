...
<ul class="no-bullets">
  <li>$A_o$ - summan av arean för alla ventilationsöppningar</li>
  <li>$h_o$ - den viktade höjden på öppningarna enligt $h_{o}=A_v/w_o$</li>
  <li>$w_o$ - den totala bredden på alla öppningar</li>
  <li>$A_t$ - den totala omslutningsarean inklusive öppningar</li>
</ul>
...
$\lambda$
: är värmeledningstalet för omgivande konstruktioner

$\rho$
: är densiteten för omgivande konstruktioner

$c_p$
: är den specifika värmen för omgivande konstruktioner
